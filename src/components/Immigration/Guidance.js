...
function Guidance() {
  return (
    <div className={`${styles.GuidanceComponet} w-11/12 md:w-10/12 mx-auto py-4 md:py-8`} id='section2'>
        <p className='text-[#FAA9FB] text-sm md:text-base mx-auto font-medium py-4 md:py-8 uppercase w-full text-center' >VISA PROCESSING GUIDANCE</p>
        <div className='w-full text-center'>
          <img  className=' w-[90%] md:w-[60%] py-2 mx-auto' src='https://images.pexels.com/photos/5699424/pexels-photo-5699424.jpeg?auto=compress&cs=tinysrgb&w=1600' />
