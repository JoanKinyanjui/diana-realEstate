...
function Laws() {
  return (
    <div className={`${styles.Laws} w-11/12 md:10/12 mx-auto py-6 md:py-12`} id='section3'>
    <p className='text-[#FAA9FB] text-sm md:text-base mx-auto font-medium py-4 md:py-8 uppercase w-full text-center' >IMMIGRATION LAWS</p>
   
    <div className='grid md:flex w-full items-center '>
  <div className='w-full md:w-1/2 grid gap-[10px] md:px-4 py-4 md:py-0'>
<div className='w-full flex h-[200px] md:h-[200px] '>
  <img className='md:w-auto mx-auto' src="https://www.mapsnworld.com/kenya/where-is-kenya.jpg" />
</div>
<div className=' w-[100%] md:w-[80%] flex h-[100px] md:h-[170px] gap-2 mx-auto'>
