...
<div className={`${styles.IndexNavMainDiv} hidden md:flex items-center justify-between  mx-auto`}>
  <div>
   <Link href='/'> <img  src='/images/logo.png' className='h-[80px] w-[120px]'/></Link>
  </div>

  <div className='flex justify-between items-center'>
   <Link href='/immigration'> <p className='px-4'>Immigration Services</p></Link>
    <Link href='/realEstate'><p className='px-4'>Realtor Services</p></Link>
  ...
  <div className='flex justify-between text-sm items-center w-full'>
   <Link href='/'> <img  src='/images/logo.png' className='h-[40px] w-[70px]'/></Link>
     <a href="mailto:dingoaconsultancy@gmail.com"> <button className={`${styles.ButtonsDiv}`}>Get in touch</button></a>
  </div>
    </div>
    </>
